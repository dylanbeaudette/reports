...
for(mu.i in mu.set) {
  ...
  a.stats <- round(c(quantile(a, probs=c(0, 0.05, 0.25, 0.5, 0.75, 0.95, 1)), sum(a), nrow(s), length(a), length(l.unsampled[[mu.i]])))
  names(a.stats) <- c('Min', 'Q5', 'Q25', 'Median', 'Q75', 'Q95', 'Max', 'Total Area', 'Samples', 'Polygons', 'Polygons Not Sampled')
