...
<br>
<div style="text-align: center; border-top-style: solid; border-bottom-style: solid; border-top-width: 2px; border-bottom-width: 2px;"><span style="font-size: 200%; font-weight: bold;">Map units: `r paste(mu.set, collapse = ", ")`</span>
<br><br>
...
kable(dcast(mu.stats, .id ~ variable, value.var = 'Q50'), row.names=FALSE, caption = 'Median Values', align = 'r', digits=dg)
```
...
l_ply(split(mu.stats, mu.stats$variable), function(i) {
  ...
  print(kable(i, caption = var.name, row.names=FALSE, align = 'r', digits=dg))
})
...
### Geomophon Landform Classification
