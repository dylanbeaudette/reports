...
##
raster.list <- list(`Mean Annual Air Temperature (degrees C)`='F:/MUSum_PRISM/final_MAAT_800m.tif', 
                    `Mean Annual Precipitation (mm)`='F:/MUSum_PRISM/final_MAP_mm_800m.tif',
                    `Effective Precipitation (mm)`='F:/MUSum_PRISM/effective_precipitation_800m.tif',
                    `Frost-Free Days`='F:/MUSum_PRISM/ffd_mean_800m.tif',
                    `Growing Degree Days (degrees C)`='F:/MUSum_PRISM/gdd_mean_800m.tif',
                    `Elevation (m)`='F:/MUSum_10m_MLRA/DEM_ARC_int_AEA.tif',
                    `Slope Gradient (%)`='F:/MUSum_10m_MLRA/Slope_ARC_int_AEA.tif',
                    `Slope Aspect (degrees)`='F:/MUSum_10m_MLRA/Aspect_ARC_int_AEA.tif',
                    `Geomorphon Landforms`='F:/MUSum_Geomorphon/forms30_region2.tif',
                    `Curvature Classes`='F:/MUSum_Curvature/curvature_classes_30_class_region2.tif'
)
...
# ##
# # path to shape file
mu.dsn <- 'D:/Workspace/Project_Folder/MUSum_shapefile'
# # SHP name, without file extension
mu.layer <- 'SDJRSYW3050SHP'
